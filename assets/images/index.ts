export const ICON_HOME =
  "https://firebasestorage.googleapis.com/v0/b/aquafina-fab2d.appspot.com/o/home.png?alt=media&token=8d9a9fcd-2bd0-4e4b-a60e-256fd7419d22";

export const ICON_LOGOUT =
  "https://firebasestorage.googleapis.com/v0/b/aquafina-fab2d.appspot.com/o/Logout.png?alt=media&token=a068d36f-01e8-4239-a293-e1804664d40e";

export const ICON_MENU =
  "https://firebasestorage.googleapis.com/v0/b/aquafina-fab2d.appspot.com/o/fi_menu.png?alt=media&token=2bcc589f-6391-4de9-9946-441b9739adff";

export const BACKGROUND_BUTTON_BLUE =
  "https://firebasestorage.googleapis.com/v0/b/aquafina-fab2d.appspot.com/o/background_button_blue.png?alt=media&token=3c8d4cc8-4541-4940-abf3-6b35731b42ff";

export const BACKGROUND_BUTTON_WHITE =
  "https://firebasestorage.googleapis.com/v0/b/aquafina-fab2d.appspot.com/o/button_mobile.png?alt=media&token=84b1fece-3927-438e-9f07-0cd2267bcad8";

export const BACKGROUND_APP =
  "https://firebasestorage.googleapis.com/v0/b/aquafina-fab2d.appspot.com/o/background_app.png?alt=media&token=b5eef333-2586-4ae9-abcd-fed7caca9221";

export const CONTENT =
  "https://firebasestorage.googleapis.com/v0/b/aquafina-fab2d.appspot.com/o/content.png?alt=media&token=2ec60b74-b49b-4bac-9104-a0bb14fe452a";

export const IMAGE_BOTTOM_LOGIN =
  "https://firebasestorage.googleapis.com/v0/b/aquafina-fab2d.appspot.com/o/image_bottom.png?alt=media&token=3335bc94-3e9d-4ed1-bc26-1ad47d2bc80a";

export const LOGO_AQUAFINA =
  "https://firebasestorage.googleapis.com/v0/b/aquafina-fab2d.appspot.com/o/logo_aquafina.png?alt=media&token=eb80595d-f61a-44b3-9885-165ee384a946";

export const ICON_LOGIN =
  "https://firebasestorage.googleapis.com/v0/b/aquafina-fab2d.appspot.com/o/icon_login.png?alt=media&token=7ec9b1fa-9a22-462c-b9b7-ff38213bae9d";
